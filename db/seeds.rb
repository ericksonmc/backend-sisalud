...
if CoverageItem.all.blank?
  CoverageItem.create([{ title: 'Cirugía Electiva', scale_items: [] },
                       { title: 'Cirugía de Emergencia', scale_items: [] },
                       { title: 'Colonoscopia', scale_items: [] },
                       { title: 'Consultas básicas ilimitadas', scale_items: [] },
                       { title: 'Consultas básicas', scale_items: [] },
                       { title: 'Consultas especializadas', scale_items: [] },
                       { title: 'Ecocardiograma, Mapa, Holter', scale_items: [] },
                       { title: 'Ecogramas básicos', scale_items: [] },
                       { title: 'Ecogramas especializados', scale_items: [] },
                       { title: 'Electrocardiograma', scale_items: [] },
                       { title: 'Exámenes Especiales', scale_items: [] },
                       { title: 'Exámenes Lab. Básicos', scale_items: [] },
                       { title: 'Exámenes Lab. Especiales', scale_items: [] },
                       { title: 'Gastroscopia', scale_items: [] },
                       { title: 'Hospitalización', scale_items: [] },
                       { title: 'Mamografía (1 x Año)', scale_items: [] },
                       { title: 'Mamografía', scale_items: [] },
                       { title: 'Mastología', scale_items: [] },
                       { title: 'Rayos X estudios simples', scale_items: [] },
                       { title: 'Rayos X', scale_items: [] },
                       { title: 'Servicios de Emergencias', scale_items: [] },
                       { title: 'Servicios de Odontología Básica', scale_items: [] },
                       { title: 'Telemedicina', scale_items: [] },
                       { title: 'Tomografía (1 x Año)', scale_items: [] },
                       { title: 'Tomografía', scale_items: [] },
                       { title: 'UCI', scale_items: [] }])
end
